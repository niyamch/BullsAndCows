...
public class HardGameActivity extends AppCompatActivity {
    ...
    Button b_minus_a, b_minus_b, b_minus_c, b_minus_d,
            b_plus_a, b_plus_b, b_plus_c, b_plus_d;
    Button b_check, b_resign, b_reset;
    TextView tv_number_a, tv_number_b, tv_number_c, tv_number_d;
    TextView tv_info, tv_output;

    Random r;

    int guessA = 0, guessB = 0, guessC = 0, guessD = 0;
    int generatedA, generatedB, generatedC, generatedD;
    int bulls=0, cows=0;
    int tries=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_minus_d = (Button) findViewById(R.id.b_minus_d);
        ...
        b_plus_d = (Button) findViewById(R.id.b_plus_d);
        ...
        tv_number_d = (TextView) findViewById(R.id.tv_number_d);
        ...
        b_minus_d.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(guessD>0) guessD--;
                tv_number_d.setText("" + guessD);
            }
        });
        ...
        b_plus_d.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(guessD<9) guessD++;
                tv_number_d.setText("" + guessD);
        ...
        b_resign.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tv_info.setText("You lost! The right number is: " + generatedA + " " + generatedB + " " + generatedC + " " + generatedD);
            }
        });
        ...
        b_check.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                if(guessA==guessB||guessA==guessC||guessA==guessD||guessB==guessC||guessB==guessD||guessC==guessD)
    ...
    private void checkWin(){
        if(bulls == 4){
            ...
            fStore.collection("triesHard").add(triesObj).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                @Override
    ...
    private void generateNumber(){
        ...
        do{
            generatedD = r.nextInt(10);
        }while(generatedD==generatedA||generatedD==generatedB||generatedD==generatedC);
    }
    ...
    private void checkNumber(){
        ...
        if(guessD==generatedD) bulls++;

        //cows
        if(guessA==generatedB||guessA==generatedC||guessA==generatedD) cows++;
        if(guessB==generatedA||guessB==generatedC||guessB==generatedD) cows++;
        if(guessC==generatedA||guessC==generatedB||guessC==generatedD) cows++;
        if(guessD==generatedA||guessD==generatedB||guessD==generatedC) cows++;

        output=output+ " " + tries + ". " + guessA + " " + guessB + " " + guessC + " " + guessD +
